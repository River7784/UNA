    ...
    <div id="wrap">
		...
		<div class="write_wrap">
			<div class="write_typing_wrap">
				<form action="${contextPath}/event/addPost.do" method="post" enctype="multipart/form-data">
			    	<ul class="write_info_wrap">
			            ...
			            <li class="write_btn_wrap">
			            	...
			            	<input type="button" class="write_reset" value="글목록" onclick="toPostList(this.form,'${contextPath}/event/listPosts.do')">
			            </li>
			        </ul>
		       </form>  
	      	</div>
