    ...
    <div id="wrap">
        ...
        <div id="bookmark_div_wrap">
            <ul id="bookmark_ul">
                ...
                <li class="bookmark_li bk_li_1"><a href="${contextPath}/event/listPost.do">두근두근 추첨마당</a></li>
		...
		<div class="modify_wrap">
			<div class="modify_typing_wrap">
				<form action="${contextPath}/event/modPost.do" method="post" enctype="multipart/form-data">				
			    	<ul class="modify_info_wrap">
			            ...
			            <li class="modify_content_wrap">
			                <textarea name="content" id="modify_content">${event.content}</textarea>
			            </li>
			            <li class="modify_file_wrap">
			            	<input type="file" name="imageFileName" value="${event.imageFileName}" onchange="readImage(this)">
			            </li>        
			            <li class="modify_preview_wrap">
			            	<img id="preview" src="${contextPath}/edownload.do?imageFileName=${event.imageFileName}&num=${event.num}" alt="이미지 미리보기">
			            </li>             
			            <li class="modify_btn_wrap">
			            	<input type="submit" class="modify_submit" value="등록">
			            	<input type="button" class="modify_reset" value="취소" onclick="toPostView(this.form, '${contextPath}/event/viewPost.do?num=${event.num}');">
			            </li>
			        </ul>
		       </form>  
	       </div>
