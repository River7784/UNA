		...
		<div class="view_wrap">		
		      <ul class="view_detail">
		          ...
		          <li class="view_info">
		              <ul class="view_info_detail">
		                   ...
		                   <li class="write_date">
			                   	...
			                   	<fmt:formatDate value="${event.writeDate}"/>                      	
		                   </li>
		                   	<li class="view_count">
		          ...
		          <li class="view_content">
		               <c:if test="${!empty event.imageFileName && event.imageFileName != null}">
		              		<img id="preview" src="${contextPath}/edownload.do?imageFileName=${event.imageFileName}&num=${event.num}">
		              		<br>
		              	</c:if>		              	
		              	${fn:replace(event.content, cn, br)}
		          </li>
		          <li class="view_btn_wrap">
		          	  <c:if test="${isLogon == true && log_id == event.writer}">
		              	<a href="${contextPath}/event/modForm.do?num=${event.num}" class="view_modify">수정</a>
		              	<a href="${contextPath}/event/delPost.do?num=${event.num}" class="view_delete">삭제</a>
		              </c:if>
		              <a href="${contextPath}/event/listPosts.do" class="view_list">글목록</a>
		          </li>        
		      </ul>
		</div>		
		<!---------- [E] container ---------->
