...
<link rel="stylesheet" href="${contextPath}/resources/css/dep_menu_2.css">
...
<script src="${contextPath}/resources/js/dep_menu_2.js"></script>
</head>
<body>
<!-------------------- [S] #wrap -------------------->
    <div id="wrap">
        ...
        <div id="dep_menu_wrap">
            <div class="first_menu_wrap menu_wrap">
                <div class="hexagon hexagon_hover hexagon1" onclick="location.href='${contextPath}/gallery/listPosts.do'">나의천체기록</div>
            ...
            <div class="second_menu_wrap menu_wrap">
                ...
                <div class="hexagon hexagon_hover hexagon5" onclick="location.href='${contextPath}/meet/listPosts.do'">우리같이가요!</div>
            </div>
            <div class="third_menu_wrap menu_wrap">
                <div class="hexagon hexagon_hover hexagon6" onclick="location.href='${contextPath}/market/listPosts.do'">중고장터</div>
