...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/book-index.css">
    ...
    <script src="${contextPath}/resources/js/turn.js"></script>
        ...
        <div id="container">
            ...
            <div id="book_area">
                <section id="explain_area">
                    <p class="ep_title_p">
                        <span class="ep_title_span ep_title_span1">환영합니다</span><br>
                        <span class="ep_title_span ep_title_span2"><span class="ep_title_span ep_title_span_point">우나<br>탐험마당</span><br>입니다</span><br>
                    </p>
