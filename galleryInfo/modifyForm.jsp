...
<!-------------------- [S] #wrap -------------------->
	...
	<div class="modify_wrap">
		<div class="modify_typing_wrap">
			<form action="${contextPath}/gallery/modPost.do" method="post" enctype="multipart/form-data">				
	    	<ul class="modify_info_wrap">
	        	<li class="modify_title">
	                ...
	                <input type="hidden" name="num" value="${gallery.num}">    
	            </li>
	            <li class="modify_content_wrap">
	                <textarea name="content" id="modify_content">${gallery.content}</textarea>
	            </li>
	            <li class="modify_file_upload">
	            	<input type="file" name="imageFileName" value="${gallery.imageFileName}" onchange="readImage(this)">
	            </li>        
	            <li class="modify_img_preview">
	            	<img id="preview" src="${contextPath}/gdownload.do?imageFileName=${gallery.imageFileName}&num=${gallery.num}" alt="이미지 미리보기">
	            </li>             
	            <li class="modify_btn_wrap">
	            	<input type="submit" class="modify_submit" value="등록">
	            	<input type="button" class="modify_reset" value="취소" onclick="toPostView(this.form, '${contextPath}/gallery/viewPost.do?num=${gallery.num}')">
	            </li>
	        </ul>
	       </form>  
       </div>
