		...
		<div class="view_wrap">		
		      <ul class="view_detail">
		          ...
		          <li class="view_content">
		               <c:if test="${!empty gallery.imageFileName && gallery.imageFileName != null}">
		              		<img id="preview" src="${contextPath}/gdownload.do?imageFileName=${gallery.imageFileName}&num=${gallery.num}">
		              		<br>
		              	</c:if>		              	
		              	${fn:replace(gallery.content, cn, br)}
		          </li>
		          <li class="view_btn_wrap">
		              <c:if test="${isLogon == true && log_id == gallery.writer}">
		              	<a href="${contextPath}/gallery/modForm.do?num=${gallery.num}" class="view_modify">수정</a>
		              	<a href="${contextPath}/gallery/delPost.do?num=${gallery.num}" class="view_delete">삭제</a>
		              </c:if>
		              <a href="${contextPath}/gallery/listPosts.do" class="view_list">글목록</a>
		          </li>        
		      </ul>
		</div>
