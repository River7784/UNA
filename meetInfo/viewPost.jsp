		...
		<div class="view_wrap">		
		      <ul class="view_detail">
		          ...
		          <li class="view_info">
		              <ul class="view_info_detail">
		                   ...
		                   <li class="write_date">
			                   	...
			                   	<fmt:formatDate value="${meet.writeDate}"/>                      	
		                   </li>
		                   	<li class="view_count">
		          ...
		          <li class="view_content">
		               <c:if test="${!empty meet.imageFileName && meet.imageFileName != null}">
		              		<img id="preview" src="${contextPath}/meetdownload.do?imageFileName=${meet.imageFileName}&num=${meet.num}">
		              		<br>
		              	</c:if>		              	
		              	${fn:replace(meet.content, cn, br)}
		          </li>
		          
		          <li class="view_btn_wrap">
		          	  <c:if test="${isLogon == true && log_id == meet.writer}">
		              	<a href="${contextPath}/meet/modForm.do?num=${meet.num}" class="view_modify">수정</a>
		              	<a href="${contextPath}/meet/delPost.do?num=${meet.num}" class="view_delete">삭제</a>
		              </c:if>
		              <a href="${contextPath}/meet/listPosts.do" class="view_list">글목록</a>
		          </li>        
		      </ul>
		</div>		
		<!---------- [E] container ---------->
